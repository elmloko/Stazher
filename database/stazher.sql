...
-- Volcando datos para la tabla stazher.attendance: ~8 rows (aproximadamente)
...
INSERT INTO `employees` (`id`, `employee_id`, `firstname`, `lastname`, `identity_card`, `address`, `email`, `birthdate`, `contact_info`, `gender`, `position_id`, `schedule_id`, `institution_id`, `modality_id`, `career_id`, `area_id`, `photo`, `created_on`, `add_hr`) VALUES
	(35, 'JC13607593', 'Jhaquelin Gabriela ', 'Condori Gallegos', 13607593, 'C/ Antonio Gallardo Z/ Gran Poder', 'gabriela1.gallegos2@gmail.com', '2000-12-13', '72079737', 'Female', 8, 2, 11, 1, 2, 0, '', '2024-05-20', NULL),
	...
	(119, 'A 9956489', 'Ariel Alvaro ', ' Sanchez Patino ', 9956489, 'Z/ Villa dolores C/ Badani 12 ', 'sanchez.9956489@gmail.com', '2003-02-17', '62342342', 'Male', 7, 2, 11, 1, 3, 1, '', '2024-06-06', '00:00:00'),
