	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Agregar Licencias </b></h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="licence_add.php">
					...
					<div class="form-group">
						<label for="date_licence" class="col-sm-3 control-label">Fecha Licencia</label>

						<div class="col-sm-9">
							<div class="date">
								<input type="date" class="form-control" id="date_licence" name="date_licence" required>
							</div>
						</div>
					</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="licence_edit.php">
					...
					<div class="form-group">
						<label for="edit_date_licence" class="col-sm-3 control-label">Fecha Licencia</label>

						<div class="col-sm-9">
							<div class="date">
								<input type="date" class="form-control" id="edit_date_licence" name="date_licence" required>
							</div>
						</div>
					</div>
			</div>
